...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/roadchain.io.git
cd roadchain.io

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/roadchain.io.git
